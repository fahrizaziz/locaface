      ...
      builder:
          (ctx) => Builder(
            builder: (BuildContext context) {
              // Use the context provided by Builder to safely access MediaQuery
              return AlertDialog(
                title: const Text(
                  "Face Registration",
                                ...
                                : Button.filled(
                                  onPressed: () async {
                                    await value.updateProfile(
                                      context: context,
                                      embed: recognition.embedding.join(','),
                                    );
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          icon: Assets.icons.reverse.svg(width: 48.h),
                        ),
                        const Spacer(),
                        IconButton(
